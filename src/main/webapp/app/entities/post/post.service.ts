...
export class PostService {
    ...
    protected convertDateFromClient(post: IPost): IPost {
        const copy: IPost = Object.assign({}, post, {
            dhPublicacao: post.dhPublicacao != null && post.dhPublicacao.isValid() ? post.dhPublicacao.toJSON() : null
        });
        return copy;
    }
    ...
    protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
        if (res.body) {
            res.body.dhPublicacao = res.body.dhPublicacao != null ? moment(res.body.dhPublicacao) : null;
        }
        return res;
    }
    ...
    protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        if (res.body) {
            res.body.forEach((post: IPost) => {
                post.dhPublicacao = post.dhPublicacao != null ? moment(post.dhPublicacao) : null;
            });
        }
        return res;
    }
